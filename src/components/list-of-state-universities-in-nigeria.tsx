...
const stateUniversities = [
    {
        ...
        about: "Abia State University (ABSU) in Uturu, Nigeria, established in 1981, is a leading institution known for academic excellence. Offering diverse undergraduate and postgraduate programs, ABSU is commited to shaping skilled professionals and contributing to societal growth.",
        abbreviation: "ABSU",
        logo: "/absu-logo.png",
        page: "/abia-state-university-absu",
        state: "Abia",
        yearFounded: "1981",
        schoolsInStateUrl: "/universities-in-abia-state",
        location: "Uturu",
        schoolsInLocationUrl: "/universities-in-uturu",
        ownership: "State",
        schoolsOfSameOwnershipUrl: "/state-universities-in-nigeria",
        vc: "Onyemachi Maxwell Ogbulu",
        aboutVcUrl: "/abia-state-university-vc",
        ranking: "40th",
        schoolsRankingUrl: "/university-ranking-in-nigeria",
        numberOfCourses: 75,
        listOfCoursesUrl: "/abia-state-university-courses",
        fees: "40k - 56k",
        feesURL: "/abia-state-university-school-fees",
        jambCutOff: 140,
        jambCutOffUrl: "/abia-state-university-cut-off-mark",
        hostel: "Yes",
        hostelUrl: "/abia-state-university-hostel",
        admissionCapacity: "4.7k",
        admissionCapacityUrl: "/abia-state-university-admission-capacity",
        ID: "absu001",
        hashtagID: "#absu001"
    ...
    },
    {
        ...
        about: "The Lagos State University (LASU) is a prominent Nigeria State University established in 1983. Located in Ojo, it offers diverse undergraduate and postgraduate programs, contributing to education and research in Lagos State",
        abbreviation: "LASU",
        logo: "/lasu-logo.png",
        page: "/lagos-state-university-lasu",
        state: "Lagos",
        yearFounded: "1983",
        schoolsInStateUrl: "/universities-in-lagos",
        location: "Ojo",
        schoolsInLocationUrl: "/universities-in-ojo",
        ownership: "State",
        schoolsOfSameOwnershipUrl: "/state-universities-in-nigeria",
        vc: "Ibiyemi Olatunji-Bello",
        aboutVcUrl: "/lasu-vc",
        ranking: "21st",
        schoolsRankingUrl: "/university-ranking-in-nigeria",
        numberOfCourses: 96,
        listOfCoursesUrl: "/lasu-courses",
        fees: "58k - 151k",
        feesURL: "/lasu-school-fees",
        jambCutOff: 200,
        jambCutOffUrl: "/lasu-cut-off-mark",
        hostel: "Yes",
        hostelUrl: "/lasu-hostel",
        admissionCapacity: "8k",
        admissionCapacityUrl: "/lasu-admission-capacity",
        ID: "lasu001",
        hashtagID: "#lasu001"
...
export default function ListOfStateUniversitiesInNigeria(){
    return(
        <div>
            <Accordion type="single" collapsible className="w-full">
            <ol>
                {stateUniversities.map((school)=>{
                    return(
                        ...
                        <li className = "flex items-center gap-x-2">
                            ...
                            <AccordionContent>
                                ...
                                <Card className = "mt-4 shadcn-card">
                                    ...
                                    <CardContent>
                {stateInfluencers.map((influencer)=>{
                    return(
